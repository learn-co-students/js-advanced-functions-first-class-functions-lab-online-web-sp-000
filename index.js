...
const returnFirstTwoDrivers = function(arr) {
    return arr.slice(0,2); //0 = first driver. 2 = to "slice" after 2 element in array.
}

//returnLastTwoDrivers() — Declare a variable with const that is assigned an anonymous function.
//The assigned function should accept an array of drivers as an argument and return the last two drivers
//in the array.
...
//fareDoubler() — Declare a variable with const and assign a function returned by createFareMultiplier()
//to it. Invoke createFareMultiplier() in such a way that the new fareDoubler() function accepts a fare
//as its lone argument and doubles it.

const fareDoubler = function(fare) {
    return createFareMultiplier(2)(fare);
}

//fareTripler() — Declare a variable with const and assign a function returned by createFareMultiplier()
//to it. Invoke createFareMultiplier() in such a way that the new fareTripler() function accepts a fare
...
function selectDifferentDrivers(arr, driverFunction) {
